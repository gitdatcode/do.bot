...
BUFFER_CLIENT_ID = process.env.BUFFER_CLIENT_ID || 'xxxxxxxxxxx';
...
//export the run function for use in other apps
module.exports.run = run;
//add the app to the command handler
command.handler.add('/buffit', run, help);
